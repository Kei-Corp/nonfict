...
document.getElementById("true-sign-up-button").addEventListener("click", signup)
document.getElementById("true-login-button").addEventListener("click", login)
document.getElementById("true-sign-up-button").addEventListener("touchstart", signup)
document.getElementById("true-login-button").addEventListener("touchstart", login)
